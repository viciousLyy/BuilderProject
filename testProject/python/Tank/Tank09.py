...
class bullet():
    def __init__(self,tank):
        #图片
        self.imageas = {
            "U":pygame.image.load("images/Bullet_U.jpg.jpg"),
        ...
        #位置
        self.image = self.imageas[self.direction]
        self.rect = self.imagea.get_rect()#炮弹区域
        if self.direction == "U":
            ...
            self.rect.top = tank.rect.top - self.rect.top/2 + tank.rect.height/2
        elif self.direction == "R":
